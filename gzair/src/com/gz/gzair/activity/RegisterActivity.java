...
import com.gz.gzair.util.UserWebServiceUtil;
...
public class RegisterActivity extends BaseActivity implements OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (v == btn_RegisterB) {
            ...
            String replyMess = wsu.addUsers(username, password,phone_num);
            if(replyMess==null){
                  try {
                    Thread.sleep(Constant.SLEEPTIME);
                    replyMess = wsu.addUsers(username, password,phone_num);
                    if(replyMess==null){
                        Thread.sleep(Constant.SLEEPTIME);
                        replyMess = wsu.addUsers(username, password,phone_num);
                    }
